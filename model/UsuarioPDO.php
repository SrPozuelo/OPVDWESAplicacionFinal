<?php
    ...
    class UsuarioPDO{
         ...
         * @return Usuario|null Objeto Usuario si las credenciales son correctas, de lo contrario devolverá null
         */
        public static function validarUsuario($codUsuario, $password){
            ...
            $sql=<<<SQL
                SELECT
                    ...
                    T01_ImagenUsuario
                FROM T01_Usuario
                WHERE T01_CodUsuario = :codUsuario AND T01_Password = SHA2(:password, 256)
            SQL;
            try{
         ...
         * @return Usuario|null Objeto Usuario con la fecha de ultima actualización actualizada.
         */
        public static function actualizarUltimaConexion($oUsuario){
            ...
            //Se actualiza el objeto Usuario en memoria.
            //La fecha actual que tenía ahora pasa a ser la anterior
            $oUsuario->setFechaHoraUltimaConexionAnterior($oUsuario->getFechaHoraUltimaConexion());
            //Se incrementa el número de accesos.
