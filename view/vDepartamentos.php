    ...
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
        <table class="formulario conErrores">
            <tr>
                ...
                <td>
                    <input type="text" name="DescDepartamento" class="texto obligatorio" id="DescDepartamento" value="<?php echo()">
                </td>
                <td id="Env">
                ...
                foreach($avDepartamentos['Departamentos'] as $Departamento){
                    ?>
                        <tr>
                            ...
                            <td>                 <?php echo ($Departamento['fechaBajaDepartamento']!=='NO TIENE') ? 'dptoBaja':''; ?></td>
                        </tr>
                    <?php
                }
            ?>
